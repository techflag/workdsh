...
与Office分工：Office拥有HTML源码编辑、隔离预览及导出，本插件仍拥有业务数据绑定、审阅、发布与撤销。HTML导出不等于发布；未来通过公开契约交接固定资源修订，不共享两套可写页面状态。见[Office插件边界](../../../docs/design/office/PLUGIN-ARCHITECTURE.md)。
