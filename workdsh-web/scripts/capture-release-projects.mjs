...
for(const theme of ['light','dark']){await p.emulateMedia({colorScheme:theme});await p.waitForTimeout(400);await p.locator('.wd-p-center').screenshot({path:'.artifacts/release-alpha8/screenshots/projects-'+theme+'.png'});}
console.log('Captured clean project main-area screenshots; no account or chat sidebar');
