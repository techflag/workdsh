...
await p.goto('http://127.0.0.1:18989/?workdsh-view=skills');await p.locator('.wd-skills').waitFor();await p.waitForTimeout(1000);await p.locator('.wd-skills').screenshot({path:'.artifacts/release-alpha8/screenshots/skills.png'});
console.log('Captured skills');
