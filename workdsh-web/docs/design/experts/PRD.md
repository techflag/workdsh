...
| 现有能力 | 匹配度 | 缺口及建议 | 来源 |
|---|---|---|---|
| 原生工作区、任务、输入框 | 部分 | 复用；增加专家绑定和草稿交接 | [工作台目录](../../../packages/plugins/workbench)、[会话规范](https://github.com/deepseek-ai/deepseek-harness/blob/dsh-v0.1.6-alpha.2/docs/subsystems/conversation.zh.md) |
