...
- [Harness Skills 官方说明](https://github.com/deepseek-ai/deepseek-harness/blob/dsh-v0.1.6-alpha.2/docs/subsystems/skills.zh.md)，作为 Skill registry/provider/scope/运行接口依据。
