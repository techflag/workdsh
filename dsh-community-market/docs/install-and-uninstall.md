...
This historical draft describes the removed Market prototype. It is not an implementation guide for the current Desktop; `desktopPnpm` is no longer available.
